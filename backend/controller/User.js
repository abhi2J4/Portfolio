...
//     if (about) user.about = { ...user.about, ...about };
...
//     await user.save();
//     res.status(200).json({ success: true, message: "Added To Youtube Videos" });
//   } catch (error) {
//     return res.status(400).json({ success: false, message: error.message });
//   }
// };
...
//     const { url, title, image, description, techStack } = req.body;
//     const user = await User.findById(req.user._id);
//     user.projects.unshift({ url, title, description, techStack, image });
//     await user.save();
...
//     user.youtube = user.youtube.filter((video) => video._id != id);
//     await user.save();
//     res.status(200).json({ success: true, message: "Deleted from Youtube" });
//   } catch (error) {
//     return res.status(400).json({ success: false, message: error.message });
//   }
// };
