  ...
  const projects = [
    {
      ...
      image: {
        url: Diabete_Prediction_AI
      },
      title: "Diabete Prediction",
      description: "Built a machine learning application to predict diabetes risk using patient health data, with an interactive and explainable interface.",
      techStack: "Streamlit, Pandas, Scikit-learn, Matplotlib, Seaborn, SHAP",
    },
    {
      _id: "2",
      url: "https://github.com/abhi2J4/Portfolio",
      image: {
        url: portfolio,
      },
      title: "Portfolio Website",
      description: "Developed a modern full-stack application using the MERN stack with Material UI for responsive design and Three.js for interactive 3D visuals to showcase personal projects.",
      techStack: "MERN,MUI,Three.js:",
    },
    {
      _id: "3",
      url: "https://github.com/abhi2J4/Full-Stack-Food-Delivery-App",
      image: {
        url: fooddevliverImage
      },
