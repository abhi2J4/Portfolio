...
//     const API = "https://portfolio-6nht.onrender.com";
...
const API = "https://portfolio-6nht.onrender.com";// depoly 
// const API = " ";// local
...
export const addTimeline = (title, description, date) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `${API}/api/v1/admin/timeline/add`,
      { title, description, date },
      { headers: { "Content-Type": "application/json" } }
    );
    dispatch({ type: "ADD_TIMELINE_SUCCESS", payload: data.message });
  } catch (error) {
    dispatch({ type: "ADD_TIMELINE_FAILURE", payload: error.response.data.message });
  }
};
...
export const deleteTimeline = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`${API}/api/v1/admin/timeline/${id}`);
    dispatch({ type: "DELETE_TIMELINE_SUCCESS", payload: data.message });
  } catch (error) {
    dispatch({ type: "DELETE_TIMELINE_FAILURE", payload: error.response.data.message });
  }
};
...
export const addYoutube = (title, url, image) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `${API}/api/v1/admin/youtube/add`,
      { title, url, image },
      { headers: { "Content-Type": "application/json" } }
    );
    dispatch({ type: "ADD_YOUTUBE_SUCCESS", payload: data.message });
  } catch (error) {
    dispatch({ type: "ADD_YOUTUBE_FAILURE", payload: error.response.data.message });
  }
};
...
export const deleteYoutube = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`${API}/api/v1/admin/youtube/${id}`);
    dispatch({ type: "DELETE_YOUTUBE_SUCCESS", payload: data.message });
  } catch (error) {
    dispatch({ type: "DELETE_YOUTUBE_FAILURE", payload: error.response.data.message });
  }
};
...
export const addProject = (title, url, image, description, techStack) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `${API}/api/v1/admin/project/add`,
      { title, url, image, description, techStack },
      { headers: { "Content-Type": "application/json" } }
    );
    dispatch({ type: "ADD_PROJECT_SUCCESS", payload: data.message });
  } catch (error) {
    dispatch({ type: "ADD_PROJECT_FAILURE", payload: error.response.data.message });
  }
};
...
export const deleteProject = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`${API}/api/v1/admin/project/${id}`);
...
export const contactUs = (name, email, message) => async (dispatch) => {
  try {
    ...
    dispatch({ type: "CONTACT_US_FAILURE", payload: error.response.data.message });
  }
};